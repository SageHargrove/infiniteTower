...
ENEMY_PORTRAIT_HINTS = {
    ...
    "Giant Rat": "(a true RODENT on all four legs like a real animal, NOT a wolf or dog, NOT standing upright on two legs, NOT a humanoid stance:1.3), a short blunt snout with twitching whiskers, small rounded ears, a plump compact rat-shaped body on short legs with front paws planted on the ground, a thin hairless ropey tail, (clearly visible matted brown-grey fur, not solid black:1.3), small dark eyes glowing red, sharp yellowed incisors bared, crouched low to the ground on all fours, well-lit dim dungeon corridor background",
    ...
    "Wolf": "(a real four-legged quadruped wolf, an ordinary canine on all four legs, NOT a werewolf, NOT bipedal, NOT humanoid:1.4), (realistic mature wolf proportions, a lean athletic build, a normal-sized head in proportion to its body, NOT chibi, NOT cute, NOT a cartoon mascot, NOT stylized as adorable:1.4), dense clearly visible grey and white fur, sharp pointed ears alert and forward, bared fangs in a vicious snarl with a threatening expression, glowing pale yellow eyes narrowed aggressively, muscular low predatory stance on all fours like a real wolf, bushy tail held low, well-lit snowy forest background, evenly lit fur with visible texture",
    "Dire Wolf": "(a real four-legged quadruped wolf, noticeably larger, bulkier and more savage-looking than an ordinary wolf, an animal on all four legs, NOT a werewolf, NOT bipedal, NOT humanoid:1.4), (dark reddish-brown shaggy fur, a distinctly different color from a grey or black wolf:1.3), a heavily scarred muzzle, oversized fangs bared, glowing amber eyes, thick powerful muscular shoulders noticeably bulkier than a normal wolf, low aggressive stance on all fours like a real animal, well-lit dead forest background, evenly lit fur with visible texture",
    "Orc": "a hulking orc warrior, (uniform green-grey mottled skin evenly visible across its entire body and face, not split into light and dark halves, not half black:1.3), a jutting lower jaw with prominent tusks, small dark eyes under a heavy brow, crude spiked iron armor plates strapped over leather, gripping a heavy cleaver-like blade, broad aggressive stance, well-lit war-camp background",
    ...
    "Goblin Warrior": "(a small wiry goblin humanoid, sickly green mottled skin clearly visible as the skin color over its whole body and face, evenly and brightly lit, NOT solid black, NOT a faceless shadow, NOT shrouded in darkness:1.5), oversized pointed ears, a hooked nose, sharp yellowed teeth bared in a snarl, wearing scavenged leather and scrap-metal armor over its chest, (gripping a simple short crude iron sword held low at its side, a plain straightforward blade shape, not an elaborate or oversized weapon:1.3), beady yellow eyes, well-lit gritty dungeon background",
    "Goblin Shaman": "(a small wiry goblin humanoid, sickly green mottled skin clearly visible as the skin color over its whole face and hands, evenly and brightly lit, NOT solid black, NOT a faceless shadow, NOT shrouded in darkness, NOT a dark hooded silhouette:1.5), oversized pointed ears, a hooked nose clearly visible on its lit green face, (simple ragged brown cloth wraps, not a heavy concealing dark robe:1.2), bone trinkets tied on with twine, gripping a crooked wooden staff topped with a glowing skull, chanting with one clawed hand raised and glowing with sickly green magic, beady yellow eyes, well-lit gritty dungeon background",
    "Giant Rat Alpha": "(a true RODENT, a large rat, NOT a horned demon, NOT a wolf or dog, NOT a cat, NOT feline, no cat-like face or whiskers shape:1.5), (realistic proportions for a large aggressive rodent, NOT chibi, NOT cute, NOT a cartoon mascot, not adorable, a genuinely menacing pest:1.4), a long pointed rodent snout with twitching whiskers, small rounded rat ears (not pointed cat ears), a stocky muscular rat-shaped body larger than an ordinary rat on all four legs, scarred patchy brown-grey fur clearly visible, a long thin hairless ropey tail clearly visible, small dark eyes glowing red, sharp yellowed rodent incisors bared in a snarl, crouched low to the ground on all fours in an aggressive stance, well-lit dim dungeon corridor background",
