...
ENEMY_PORTRAIT_HINTS = {
    ...
    "Wolf": "(a real four-legged quadruped wolf, an ordinary canine on all four legs, NOT a werewolf, NOT bipedal, NOT humanoid:1.4), dense clearly visible grey and white fur, sharp pointed ears alert and forward, bared fangs in a snarl, glowing pale yellow eyes, muscular low predatory stance on all fours like a real wolf, bushy tail held low, well-lit snowy forest background, evenly lit fur with visible texture",
    "Dire Wolf": "(a real four-legged quadruped wolf, larger and more savage than an ordinary wolf, an animal on all four legs, NOT a werewolf, NOT bipedal, NOT humanoid:1.4), shaggy clearly visible grey fur, a scarred muzzle, oversized fangs bared, glowing amber eyes, thick powerful shoulders, low aggressive stance on all fours like a real animal, well-lit dead forest background, evenly lit fur with visible texture",
    ...
    "Slime": "(a translucent gelatinous blob creature, clearly visible glossy teal-blue jelly body you can partly see into, NOT solid black, NOT a silhouette:1.4), a simple round wobbling blob shape sitting on the ground, small dark beady eyes near the top, glistening wet highlights across its translucent surface, faint bubbles suspended inside its jelly body, well-lit dungeon floor background",
    "Acid Slime": "(a translucent gelatinous blob creature, clearly visible glowing acid-green corrosive jelly body you can partly see into, NOT solid black, NOT humanoid, NOT a person, NOT wearing clothes:1.4), a simple round wobbling blob shape sitting on the ground, faint caustic green vapor rising off its surface, small dark beady eyes near the top, acid droplets dripping from its body leaving small smoking scorch marks on the floor, well-lit dungeon floor background",
    "Goblin Warrior": "(a small wiry goblin humanoid, sickly green mottled skin clearly visible as the skin color, NOT solid black, NOT a faceless shadow:1.4), oversized pointed ears, a hooked nose, sharp yellowed teeth bared in a snarl, wearing scavenged leather and scrap-metal armor over its chest, gripping a crude rusted sword raised in a battle-ready stance, beady yellow eyes, well-lit gritty dungeon background",
    "Goblin Shaman": "(a small wiry goblin humanoid, sickly green mottled skin clearly visible as the skin color, NOT solid black, NOT a faceless shadow:1.4), oversized pointed ears, a hooked nose, ragged dark ritual robes with bone trinkets tied on with twine, gripping a crooked wooden staff topped with a glowing skull, chanting with one clawed hand raised and glowing with sickly green magic, beady yellow eyes, well-lit gritty dungeon background",
    "Giant Rat Alpha": "(a true RODENT, a large rat, NOT a horned demon, NOT a wolf or dog:1.4), a short blunt snout with twitching whiskers, small rounded ears, a stocky muscular rat-shaped body larger than an ordinary rat, scarred patchy brown-grey fur clearly visible, a thin hairless ropey tail, small dark eyes glowing red, sharp yellowed incisors bared in a snarl, crouched low to the ground in an aggressive stance, well-lit dim dungeon corridor background",
